...
from data.dex_ycbv.dex_ycbv import DEX_YCBVDataset
# from timer import Timer
from models.utils.logger import colorlogger
...
class Trainer(Base):
    def __init__(self, base_path='/home/ana/Study/CVPR/hand/data/dex_ycbv/data'):
