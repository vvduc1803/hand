...
from models.utils.preprocessing import get_bbox, process_bbox

from models.utils.mano import MANO

mano = MANO()

from torch.utils.data import Dataset
from models.utils.preprocessing import load_img, augmentation, load_depth_img, augmentation_depth
from models.utils.transforms import rigid_align
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            targets = {'joints_img': joints_img, 'joints_coord_cam': joints_coord_cam, 'mano_pose': mano_pose,
                       'mano_shape': mano_shape, 'gt': depth}
