...
from losses.losses import hand_loss, idisc_loss
...
def main():
    ...
    #     log_with="wandb",
    #     project_dir='/home/ana/Study/CVPR/hand'
    # )
    ...
    for epoch in range(trainer.start_epoch, cfg.end_epoch):
        ...
        for train_itr, (inputs, targets, meta_info) in enumerate(progress_bar):
            ...
            hand_out, depth_out = trainer.model(inputs, targets)

            loss_hand = hand_loss(hand_out, targets)
            loss_depth = idisc_loss(depth_out, targets['gt'])
        ...
        with torch.inference_mode():
            ...
            for test_itr, (inputs, targets, meta_info) in enumerate(tqdm(progress_bar2)):
                ...
                # forward
                hand_out, out = trainer.model(inputs, targets)
